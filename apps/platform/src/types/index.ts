...
export const API_PATHS = {
  ...
  stats: '/platform/v1/stats',
  tenants: '/platform/v1/tenants',
  tenant: (id: string) => `/platform/v1/tenants/${id}`,
  tenantSuspend: (id: string) => `/platform/v1/tenants/${id}/suspend`,
  tenantActivate: (id: string) => `/platform/v1/tenants/${id}/activate`,
  tenantUsage: (id: string) => `/platform/v1/tenants/${id}/usage`,
  tenantUsers: (id: string) => `/platform/v1/tenants/${id}/users`,
  tenantUser: (id: string, userId: string) => `/platform/v1/tenants/${id}/users/${userId}`,
  tenantBackups: (id: string) => `/platform/v1/tenants/${id}/backups`,
  tenantAuditLogs: (id: string) => `/platform/v1/tenants/${id}/audit-logs`,
  users: '/platform/v1/users',
  user: (id: string) => `/platform/v1/users/${id}`,
  subscriptions: '/platform/v1/subscriptions',
  subscription: (id: string) => `/platform/v1/subscriptions/${id}`,
  auditLogs: '/platform/v1/audit-logs',
  settings: '/platform/v1/settings',
} as const;
